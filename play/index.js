...
.add("Autoplay, play on hover", h => createContainer(
    h, containerWidth, [h(Carousel, { props: { autoplay: true, autoplayHoverPlay: true, autoplayHoverPause: false } }, generateSlideImages(h))]
)
)
